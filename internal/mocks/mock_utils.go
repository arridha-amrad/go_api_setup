...
func (mr *MockIUtilsMockRecorder) GenerateRandomBytes(size interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockIUtils) GenerateToken(userId uuid.UUID) (string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIUtilsMockRecorder) GenerateToken(userId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GenerateToken", reflect.TypeOf((*MockIUtils)(nil).GenerateToken), userId)
}
...
func (mr *MockIUtilsMockRecorder) GetTokenFromRefreshToken(config interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIUtilsMockRecorder) HashPassword(password interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIUtilsMockRecorder) HashWithSHA256(randomStr interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIUtilsMockRecorder) SendEmailWithGmail(subject, body, address interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIUtilsMockRecorder) ValidateToken(tokenString interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIUtilsMockRecorder) VerifyPassword(hashedPassword, password interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
